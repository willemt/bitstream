...
void bitstream_init(unsigned char *bytes, unsigned int size);
...
void bitstream_write_uint32_from_bitoffset(unsigned char **bytes, const uint32_t val, const unsigned int nbits, unsigned int* read_pos_bits);

void bitstream_read_uint32_from_bitoffset(unsigned char **bytes, uint32_t * val, const unsigned int nbits, unsigned int* read_pos_bits);

int bitstream_read_bit(unsigned char **bytes, unsigned int* read_pos_bits);
